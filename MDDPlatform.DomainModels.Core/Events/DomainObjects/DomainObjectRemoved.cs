...
public class DomainObjectRemoved : IDomainEvent
{
    ...
    public DomainObjectRemoved(Guid domainId, Guid domainConceptId, object domainObjectId, object name, object type)
    {
        DomainId = domainId;
